...
void Photon::FPSCamera::HandleInput()
{
	...
	if (input_manager_instance.GetKey(KeyCode::E, KeyAction::Pressed))
	{
	...
	if (input_manager_instance.GetKey(KeyCode::LeftShift, KeyAction::Pressed))
	{
		m_current_speed = m_run_speed;
	}
	if (input_manager_instance.GetKey(KeyCode::LeftShift, KeyAction::Release))
	{
